...
public class Safecount {
	...
	*/
	public static class TokenizerMapper
		...
		public void map(Object key, Text value, Context context)
			...
			if(adress.length >= 6){
				city.set(adress[2]+ " " + adress[5]);
				if(adress.length == 6)
					context.write(city,one);
				else
					context.write(city,new IntWritable(Integer.parseInt(adress[6])));	
			}
		}
	}
	...
	*/
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf,"safe count");	
		job.setJarByClass(Safecount.class);
