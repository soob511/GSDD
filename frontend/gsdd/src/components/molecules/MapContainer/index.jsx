...
// import { SET_TMAPV2, SET_MAP, SET_MARKER, SET_POSITION, SET_LOCATION, SET_MARKERS, SET_PLACES } from '../../../reducers/tmapReducer';
...
// import { Input, TextField, Autocomplete, getInputLabelUtilityClasses } from '@mui/material';
...
//     dispatch(SET_MAP(await mapInfo()));
//   };

//   // const getMode = async () => {
//   //   setMode(!mode);
//   //   dispatch(SET_MARKERS(await getMarkers(TmapV2, map, position.coords.latitude, position.coords.longitude)));
//   // };
...
//           <Button styleType="modal">검색</Button>
