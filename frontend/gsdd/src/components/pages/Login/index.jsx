  ...
  return (
    <>
      <S.Login>
        ...
        <Button styleType="login" kakao href="https://j7b209.p.ssafy.io/api/oauth2/authorization/kakao">
          <S.BtnLogo src={kakao}></S.BtnLogo>
          <S.BtnText>카카오톡으로 시작하기</S.BtnText>
        </Button>
        <Button styleType="login" naver href="https://j7b209.p.ssafy.io/api/oauth2/authorization/naver">
          <S.BtnLogo src={naver}></S.BtnLogo>
          <S.BtnText>네이버로 시작하기</S.BtnText>
        </Button>
        <Button styleType="login" google href="http://j7b209.p.ssafy.io/api/oauth2/authorization/google">
